...
class HTTPHelper {
  ...
  Future<List<Map>> fetchItems() async {
    ...
    http.Response response = await http
        .get(Uri.parse('http://examination.24x7retail.com/api/v1.0/Employees'));
  ...
  Future<Map> getItem(itemId) async {
    ...
    http.Response response = await http.get(Uri.parse(
        'http://examination.24x7retail.com/api/v1.0/Employee/$itemId'));
...
//-- Update an item
  ...
  Future<bool> deleteItem(String itemId) async {
    ...
    http.Response response = await http.delete(
      Uri.parse('http://examination.24x7retail.com/api/v1.0/Employee/$itemId'),
    );
